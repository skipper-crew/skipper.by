    ...
    */
            ...
            <form id="frmaddpost" name="frmaddpost" method="post" action="" enctype="multipart/form-data">
                    <div class="addpostmaindiv">
                            ...
                            <div class="addpostinnerdiv">
                                    ...
                                    <div class="addpostctrl">
                                            <p><textarea id="post_content" name="post_content" class="txtareabgcont" cols="40" rows="20" onkeyup="cnt(this,document.frmaddpost.c)" style="width: 90%" <?php if(get_option('wppostreviewbyadmin_enableeditor') == "")        { ?> onkeyup="limiter()" <?php } ?> ><?php echo $_POST['post_content']; ?></textarea>
                                            </p>
                                            <?php if(get_option('wppostreviewbyadmin_enableeditor') == "")  { ?>
                            <p>
    ...
    <p align="right" style="float:right;padding-right:30px;"><small style="padding:0px 0px 0px 10px;">Word Count: <input type="text" name="c" value="0" size="5"
    onkeyup="cnt(document.frmaddpost.w,this)" /></small></p>
                            ...
                            <div class="addpostinnerdiv">
                                    ...
                                    <div class="addpostctrl">
                                            <p><img id="captcha" src="/wp-content/plugins/wordpress-guest-post/securimage/securimage_show.php?sid=<?php echo md5(uniqid()) ?>" alt="CAPTCHA Image" border="0" /> <object type="application/x-shockwave-flash" data="<?php get_bloginfo('wpurl')?>/wp-content/plugins/wordpress-guest-post/securimage/securimage_play.swf?audio_file=<?php get_bloginfo('wpurl')?>/wp-content/plugins/wordpress-guest-post/securimage/securimage_play.php&amp;bgColor1=#fff&amp;bgColor2=#fff&amp;iconColor=#777&amp;borderWidth=1&amp;borderColor=#000" height="32" width="32">
        <param name="movie" value="<?php get_bloginfo('wpurl')?>/wp-content/plugins/wordpress-guest-post/securimage/securimage_play.swf?audio_file=<?php get_bloginfo('wpurl')?>/wp-content/plugins/wordpress-guest-post/securimage/securimage_play.php&amp;bgColor1=#fff&amp;bgColor2=#fff&amp;iconColor=#777&amp;borderWidth=1&amp;borderColor=#000">
        </object></p>
    ...
    <a href="#" onclick="document.getElementById('captcha').src = '/wp-content/plugins/wordpress-guest-post/securimage/securimage_show.php?' + Math.random(); return false">[ Different Image ]</a>                                
                                            </p>
    ...
    <center><small>Powered By <a href="http://lisaangelettieblog.com/wordpress-guest-post-plugin">Wordpress Guest Post</a></small></center>
                    </p>
            </div>
    <?php
    }      
