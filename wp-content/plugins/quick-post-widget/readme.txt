...
= 1.9.1 =
* Fixed positioning bug with widget on page.
* Completed German translation (big thanks to Sadik).
* Small CSS change to solve a category checklist display problem.
* Solved date bug in post feeds.
