...
package
{
	...
	public class Player extends Application
	{
		...
		{	
			...
			{
				connectStr.text = "http://194.84.36.34:1935/vod/mp4:sample2.mp4/manifest.f4m";					
			}
			...
			// *********************** stream examples ******************//
			// http://localhost:1935/vod/mp4:sample2.mp4/manifest.f4m
			// http://localhost:1935/vod/smil:streamNames.smil/manifest.f4m (server-side smil)
			// rtmp://localhost:1935/vod/mp4:sample2.mp4
